<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("userVarOut");
					i++;


		var j=0;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid userVarOut");
							myInputs[j].focus();
							return false;
						}
...
<div id="container">
	<div id="header">
		User Task Form: UserName Validation.GetLoginUser
	</div>
	<div id="content">
		...
		<fieldset>
            <legend>Task Inputs</legend>
                            		<label for="name">userVarIn</label>
                            		<div class="div_checkbox">
                              		${userVarIn}
                            		</div>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		<label for="name">userVarOut</label>
                            		<div class="div_texbox">
                              		<input name="userVarOut" type="text" class="textbox" id="userVarOut" value="${userVarOut}" />
                            		</div>
